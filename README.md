...
| F3 | **Rich Messages** | Resposta final em Rich Markdown (headings, tabelas, code, task list); os trechos intermediários entre ferramentas vão num `<details>` colapsável; rodapé de tempo/custo em itálico. Fallback automático para HTML e texto puro. |
